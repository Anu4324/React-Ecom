...
function getAPIData() {
dispatch(getSubcategory()); // Corrected to invoke getSubcategory as a function
  ...
  <div className="container-fluid page-header py-5">
    ...
    <ol className="breadcrumb justify-content-center mb-0">
      ...
      <li className="breadcrumb-item active text-white">
        <Link to="/AdminSubcategory" className="text-white">AdminSubcategory</Link>
      </li>
    </ol>
  </div>
  {/*
          ...
          <table className="table table-bordered table-hover">
            <tbody>
              ...
              <tr key={index} className="text-center">
                ...
                <td>{item.name}</td>
                <td>
                  <Link to={"/AdminUpdateSubcategory/" + item.id} className="text-primary">
